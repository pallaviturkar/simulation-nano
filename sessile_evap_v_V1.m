...
BF_radius = BaseFluid.data(4:loc,3)/1000;% mm  to m
...
%V(1) = ((R^3/sin^3*(Theta))*pi*(Beta)/3;% spherical from Erbil review 2012 
 V(1)    = (R^3.*pi*(Beta)/3)/((3.*sin(Theta)-sin(3.*Theta))/4)
